...
class Eng_Config {
	...
	protected static $viewClassName = 'Eng_View'; // e.g. AppView
	 ...
	 *
	 * @var mixed Eng_View object if one is found, otherwise null.
	 * @see getControllerView(), getElementView(), getLayoutView(), Eng_Config::setViewClassName()
	 **/
