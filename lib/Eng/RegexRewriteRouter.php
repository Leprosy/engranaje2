 ...
 * @since 2007-05-08
 **/
class Eng_RegexRewriteRouter implements Eng_RouterInterface {
	 ...
	 * the defaults will be used by the Eng_FrontController.
	 * 
	...
	/**
	 * Routes like {@link Eng_RewriteRouter} does, with the additional check to
	 * routes for specifying custom routes based on regular expressions.
	 * 
	 * @param Eng_HttpRequest $request A request object to route.
	 * @return boolean
	 * @author Anthony Bush
	 * @since 2007-05-08
	 **/
